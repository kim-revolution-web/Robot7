...
class Argument(Node):
    ...
    def __init__(self):
        ...
        self.arithmetic_argument_publisher = self.create_publisher(
            ...
            'arithmetic_argument',
            QOS_RKL10V)
        self.timer = self.create_timer(1.0, self.publish_random_arithmetic_arguments) #publisher는 매번 값을 보내줘서  주기적으로 실행해야 할 떄가 많음
    ...
    def update_parameter(self, params):
        ...
        return SetParametersResult(successful=True) #이번 파라미터 변경 요청을 승인한다
